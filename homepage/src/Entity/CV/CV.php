...
class CV {
    ...
    public static function myCv(): CV {
        $employers = [
            new Employer('07/2017 - present','Self employed','Stay at home dad','Looking after children. In spare time generously over-engineering a custom web project in PHP/Symfony, Typescript/React for a local pub to plan/manage staff rota, store accounting data, track revenue, receipts, labour rates, etc.'),
            new Employer('08/2014 - 06/2017, 02/2018 (part time contractor)','Softwire','Software Developer','Developer working on various client projects including BBC Music and David Lloyd Leisure'),
